...
| --- | --- | --- | --- | --- |
| M0 | M0.1 | pnpm monorepo, packages + app skeletons, TS project refs, strict confi | — | — |
...
| M0 | M0.8 | Templates: PROGRESS, DECISIONS, KNOWN_ISSUES, NAMING, README | — | — |
...
| M1 | M1.4 | `SequentialScheduler`, `AllGoalsRace`, `SimultaneousScheduler` stub | 4.2 (GDD.md) | GDD |
| M1 | M1.5 | Start-of-turn pipeline in exact GDD order | — | GDD |
| M1 | M1.6 | Movement + enter/exit + hour accounting (walk only) | — | — |
| M1 | M1.7 | Command validators + `applyCommand` for classic commands (jobs, work,  | — | — |
...
| M2 | M2.1 | Zod schemas for all pack files + cross-file validators | — | — |
| M2 | M2.2 | `classic` pack: board, 16 locations, 11 degrees, full job table satisf | 3.4 (ORIGINAL_REFERENCE.md) | — |
...
| M4 | M4.2 | Title, Setup (all GDD 4.1 options), Settings, Stats screens | 4.1 (GDD.md) | GDD |
...
| M5 | M5.1 | Feature flags plumbing (engine + UI hide) | — | — |
...
| M7 | M7.2 | Save system: autosave, 3 slots, export/import, migrations, replay veri | — | — |
| M7 | M7.3 | Tutorial (UX 7.6) with spotlight + event-driven steps | 7.6 (UX_SPEC.md) | — |
| M7 | M7.4 | Classic opacity mode | — | — |
| M7 | M7.5 | Themes, text scale, final a11y pass | — | — |
| M8 | M8.1 | `NAMING.md` final: 5 title proposals, rival names, location names; set | — | — |
| M8 | M8.2 | README (play, controls, dev setup, architecture summary, how to add a  | — | — |
